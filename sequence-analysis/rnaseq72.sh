...
for i in A1 A3 A4 B1 B3 B4 C1 C3 C4 D1 D3 D4 E1 E3 E4 F1 F3 F4 G1 G3 G4 H1 H3 H4 I1 I3 I4 J1 J3 J4 K1 K3 K4 L1 L3 L4 M1 M3 M4 N1 N3 N4 O1 O3 O4\
P1 P3 P4 R1 R3 R4 S1 S3 S4 T1 T3 T4 U1 U3 U4 W1 W3 W4 X1 X3 X4 Y1 Y3 Y4 Z1 Z3 Z4 ;\
do java -jar /home/mj/bin/Trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 4 \
../sekw-surowe/rna/ps23/2023_07_10/raw_data/${i}_R1_001.fastq.gz \
../sekw-surowe/rna/ps23/2023_07_10/raw_data/${i}_R2_001.fastq.gz \
-baseout ${i}.fastq.gz ILLUMINACLIP:/home/mj/bin/Trimmomatic-0.39/adapters/TruSeq3-PE-2.fa:2:30:10:2:true MINLEN:40; done

###############################################################
# Above loop is suboptimal, below better option
for i in {A..Z}; do \
for j in {1..4}; do \
wc -l ${i}${j}; done ; done
# If some values from range don't exist then empty files could potentially be created
# In such case find helps
find . -size 0c -delete
# End of example
###############################################################
...
for j in 1 3 4; do \
~/bin/STAR_2.7.10b/Linux_x86_64/STAR --runThreadN 8 --readFilesIn ../2023_07_10.trim/${i}${j}_1P.fastq.gz ../2023_07_10.trim/${i}${j}_2P.fastq.gz \
--genomeDir ~/star-index --outSAMtype BAM SortedByCoordinate --outFileNamePrefix ${i}${j} --readFilesCommand zcat
~/bin/BamQC/bin/bamqc ${i}${j}Aligned.sortedByCoord.out.bam --threads 8 -f ~/NAMv5/Zea_mays.Zm-B73-REFERENCE-NAM-5.0.55.chr.gtf \
-o ../2023_07_10.bamqc/; done; done
...
for j in 1 3 4; do \
~/bin/STAR_2.7.10b/Linux_x86_64/STAR --limitBAMsortRAM 31619156 --genomeLoad LoadAndKeep --runThreadN 8 \
--readFilesIn ../2023_07_10.trim/${i}${j}_1P.fastq.gz ../2023_07_10.trim/${i}${j}_2P.fastq.gz --genomeDir ~/star-index \
--outSAMtype BAM SortedByCoordinate --outFileNamePrefix ${i}${j} --readFilesCommand zcat; done; done
...
for j in 1 3 4; do \
~/bin/STAR_2.7.10b/Linux_x86_64/STAR --runThreadN 8 --readFilesIn ../2023_07_10.trim/${i}${j}_1P.fastq.gz ../2023_07_10.trim/${i}${j}_2P.fastq.gz \
--genomeDir ~/star-index --outSAMtype BAM SortedByCoordinate --outFileNamePrefix ${i}${j} --readFilesCommand zcat; done; done
...
for i in A B C D E F G H I J K L M N O P R S T U W X Y Z; do \
for j in 1 3 4; do \
samtools view -@8 -bq10 ${i}${j}Aligned.sortedByCoord.out.bam -o q10-srt-idx/${i}${j}q10.bam && samtools sort -@8 \
-o q10-srt-idx/${i}${j}q10srt.bam q10-srt-idx/${i}${j}q10.bam && cd q10-srt-idx && samtools index -@8 ${i}${j}q10srt.bam \
&& rm ${i}${j}q10.bam && echo zrobione ${i}${j} && cd .. ; done; done
# In the same script multiBamSummary for each new relication was run
cd q10-srt-idx

multiBamSummary bins --bamfiles \
A1q10srt.bam B1q10srt.bam C1q10srt.bam D1q10srt.bam E1q10srt.bam F1q10srt.bam G1q10srt.bam H1q10srt.bam I1q10srt.bam J1q10srt.bam K1q10srt.bam L1q10srt.bam M1q10srt.bam N1q10srt.bam O1q10srt.bam P1q10srt.bam R1q10srt.bam S1q10srt.bam T1q10srt.bam U1q10srt.bam W1q10srt.bam X1q10srt.bam Y1q10srt.bam Z1q10srt.bam \
--labels \
l.a5.18 l.a5.02 l.a5.10 l.s0.18 l.s0.02 l.s0.10 l.s8.18 l.s8.02 l.s8.10 l.s3.18 l.s3.02 l.s3.10 s.a5.18 s.a5.02 s.a5.10 s.s0.18 s.s0.02 s.s0.10 s.s8.18 s.s8.02 s.s8.10 s.s3.18 s.s3.02 s.s3.10 \
-p 8 -o ../../2023_07_10.pca/macierz1.npz

multiBamSummary bins --bamfiles \
A3q10srt.bam B3q10srt.bam C3q10srt.bam D3q10srt.bam E3q10srt.bam F3q10srt.bam G3q10srt.bam H3q10srt.bam I3q10srt.bam J3q10srt.bam K3q10srt.bam L3q10srt.bam M3q10srt.bam N3q10srt.bam O3q10srt.bam P3q10srt.bam R3q10srt.bam S3q10srt.bam T3q10srt.bam U3q10srt.bam W3q10srt.bam X3q10srt.bam Y3q10srt.bam Z3q10srt.bam \
--labels \
l.a5.18 l.a5.02 l.a5.10 l.s0.18 l.s0.02 l.s0.10 l.s8.18 l.s8.02 l.s8.10 l.s3.18 l.s3.02 l.s3.10 s.a5.18 s.a5.02 s.a5.10 s.s0.18 s.s0.02 s.s0.10 s.s8.18 s.s8.02 s.s8.10 s.s3.18 s.s3.02 s.s3.10 \
-p 8 -o ../../2023_07_10.pca/macierz3.npz

multiBamSummary bins --bamfiles \
A4q10srt.bam B4q10srt.bam C4q10srt.bam D4q10srt.bam E4q10srt.bam F4q10srt.bam G4q10srt.bam H4q10srt.bam I4q10srt.bam J4q10srt.bam K4q10srt.bam L4q10srt.bam M4q10srt.bam N4q10srt.bam O4q10srt.bam P4q10srt.bam R4q10srt.bam S4q10srt.bam T4q10srt.bam U4q10srt.bam W4q10srt.bam X4q10srt.bam Y4q10srt.bam Z4q10srt.bam \
--labels \
l.a5.18 l.a5.02 l.a5.10 l.s0.18 l.s0.02 l.s0.10 l.s8.18 l.s8.02 l.s8.10 l.s3.18 l.s3.02 l.s3.10 s.a5.18 s.a5.02 s.a5.10 s.s0.18 s.s0.02 s.s0.10 s.s8.18 s.s8.02 s.s8.10 s.s3.18 s.s3.02 s.s3.10 \
-p 8 -o ../../2023_07_10.pca/macierz4.npz
...
plotPCA -in macierz1.npz \
-l \
l.a5.18 l.a5.02 l.a5.10 l.s0.18 l.s0.02 l.s0.10 l.s8.18 l.s8.02 l.s8.10 l.s3.18 l.s3.02 l.s3.10 s.a5.18 s.a5.02 s.a5.10 s.s0.18 s.s0.02 s.s0.10 s.s8.18 s.s8.02 s.s8.10 s.s3.18 s.s3.02 s.s3.10 \
--colors \
'#f06292' '#f06292' '#f06292' '#4dd0e1' '#4dd0e1' '#4dd0e1' '#aed581' '#aed581' '#aed581' '#ffe082' '#ffe082' '#ffe082' '#c2185b' '#c2185b' '#c2185b' '#0097a7' '#0097a7' '#0097a7' '#689f38' '#689f38' '#689f38' '#ffa000' '#ffa000' '#ffa000' \
--markers 'v' 'o' 'x' --transpose -o pca1.svg

plotPCA -in macierz3.npz \
-l \
l.a5.18 l.a5.02 l.a5.10 l.s0.18 l.s0.02 l.s0.10 l.s8.18 l.s8.02 l.s8.10 l.s3.18 l.s3.02 l.s3.10 s.a5.18 s.a5.02 s.a5.10 s.s0.18 s.s0.02 s.s0.10 s.s8.18 s.s8.02 s.s8.10 s.s3.18 s.s3.02 s.s3.10 \
--colors \
'#f06292' '#f06292' '#f06292' '#4dd0e1' '#4dd0e1' '#4dd0e1' '#aed581' '#aed581' '#aed581' '#ffe082' '#ffe082' '#ffe082' '#c2185b' '#c2185b' '#c2185b' '#0097a7' '#0097a7' '#0097a7' '#689f38' '#689f38' '#689f38' '#ffa000' '#ffa000' '#ffa000' \
...
--labels \
l.a5.18d1 l.a5.02d1 l.a5.10d1 l.s0.18d1 l.s0.02d1 l.s0.10d1 l.s8.18d1 l.s8.02d1 l.s8.10d1 l.s3.18d1 l.s3.02d1 l.s3.10d1 s.a5.18d1 s.a5.02d1 s.a5.10d1 s.s0.18d1 s.s0.02d1 s.s0.10d1 s.s8.18d1 s.s8.02d1 s.s8.10d1 s.s3.18d1 s.s3.02d1 s.s3.10d1 l.a5.18d2 l.a5.02d2 l.a5.10d2 l.s0.18d2 l.s0.02d2 l.s0.10d2 l.s8.18d2 l.s8.02d2 l.s8.10d2 l.s3.18d2 l.s3.02d2 l.s3.10d2 s.a5.18d2 s.a5.02d2 s.a5.10d2 s.s0.18d2 s.s0.02d2 s.s0.10d2 s.s8.18d2 s.s8.02d2 s.s8.10d2 s.s3.18d2 s.s3.02d2 s.s3.10d2 l.a5.18d3 l.a5.02d3 l.a5.10d3 l.s0.18d3 l.s0.02d3 l.s0.10d3 l.s8.18d3 l.s8.02d3 l.s8.10d3 l.s3.18d3 l.s3.02d3 l.s3.10d3 s.a5.18d3 s.a5.02d3 s.a5.10d3 s.s0.18d3 s.s0.02d3 s.s0.10d3 s.s8.18d3 s.s8.02d3 s.s8.10d3 s.s3.18d3 s.s3.02d3 s.s3.10d3 l.a5.18d4 l.a5.02d4 l.a5.10d4 l.s0.18d4 l.s0.02d4 l.s0.10d4 l.s8.18d4 l.s8.02d4 l.s8.10d4 l.s3.18d4 l.s3.02d4 l.s3.10d4 s.a5.18d4 s.a5.02d4 s.a5.10d4 s.s0.18d4 s.s0.02d4 s.s0.10d4 s.s8.18d4 s.s8.02d4 s.s8.10d4 s.s3.18d4 s.s3.02d4 s.s3.10d4 \
-p 8 -o ../../2023_07_10.pca/macierz1powt.npz

~/bin/subread-2.0.6-Linux-x86_64/bin/featureCounts -C  -B  -Q 10  -F GTF  -s 2  -T 8  --ignoreDup  -p  --countReadPairs  -t exon  -g gene_id  \
...
--markers \
'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' \
--transpose --plotHeight 20 --plotWidth 20 --PCs 2 3 -o pca1p23-samN.svg

plotCorrelation --corData macierz1powt-samN.npz -c pearson -p heatmap -o samN.svg

# PCA, tweaking with colors
plotPCA -in macierz1powt-lisc.npz \
-l \
a5.18d1 a5.02d1 a5.10d1 s0.18d1 s0.02d1 s0.10d1 s8.18d1 s8.02d1 s8.10d1 s3.18d1 s3.02d1 s3.10d1 a5.18d2 a5.02d2 a5.10d2 s0.18d2 s0.02d2 s0.10d2 s8.18d2 s8.02d2 s8.10d2 s3.18d2 s3.02d2 s3.10d2 a5.18d3 a5.02d3 a5.10d3 s0.18d3 s0.02d3 s0.10d3 s8.18d3 s8.02d3 s8.10d3 s3.18d3 s3.02d3 s3.10d3 a5.18d4 a5.02d4 a5.10d4 s0.18d4 s0.02d4 s0.10d4 s8.18d4 s8.02d4 s8.10d4 s3.18d4 s3.02d4 s3.10d4 \
--colors \
'#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#fff59d' '#fdd835' '#f57f17' '#fff59d' '#fdd835' '#f57f17' '#fff59d' '#fdd835' '#f57f17' '#fff59d' '#fdd835' '#f57f17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' \
--markers \
'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' \
--transpose --plotHeight 20 --plotWidth 20 -o pca1p-lisc.svg

plotPCA -in macierz1powt-sam.npz \
-l \
a5.18d1 a5.02d1 a5.10d1 s0.18d1 s0.02d1 s0.10d1 s8.18d1 s8.02d1 s8.10d1 s3.18d1 s3.02d1 s3.10d1 a5.18d2 a5.02d2 a5.10d2 s0.18d2 s0.02d2 s0.10d2 s8.18d2 s8.02d2 s8.10d2 s3.18d2 s3.02d2 s3.10d2 a5.18d3 a5.02d3 a5.10d3 s0.18d3 s0.02d3 s0.10d3 s8.18d3 s8.02d3 s8.10d3 s3.18d3 s3.02d3 s3.10d3 a5.18d4 a5.02d4 a5.10d4 s0.18d4 s0.02d4 s0.10d4 s8.18d4 s8.02d4 s8.10d4 s3.18d4 s3.02d4 s3.10d4 \
--colors \
'#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#fff59d' '#fdd835' '#f57f17' '#fff59d' '#fdd835' '#f57f17' '#fff59d' '#fdd835' '#f57f17' '#fff59d' '#fdd835' '#f57f17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' \
--markers \
'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' \
--transpose --plotHeight 20 --plotWidth 20 -o pca1p-sam.svg

# Useful options: --plotHeight 20 --plotWidth 20 --PCs 2 3 (number of Principal Components to print)
...
# Trymowanie i Fastqc
for i in A4 G3_S9 ; do java -jar /home/mj/bin/Trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 8 \
../../sekw-surowe/rna/ps23/2023_08_24/raw_data/${i}_R1_001.fastq.gz ../../sekw-surowe/rna/ps23/2023_08_24/raw_data/${i}_R2_001.fastq.gz \
-baseout ${i}.fastq.gz ILLUMINACLIP:/home/mj/bin/Trimmomatic-0.39/adapters/TruSeq3-PE-2.fa:2:30:10:2:true MINLEN:40; done
...
# Mapowanie
for i in A4 G3_S9 ; do ~/bin/STAR_2.7.10b/Linux_x86_64/STAR --runThreadN 24 \
--readFilesIn ../2023_08_24.trim/${i}_1P.fastq.gz ../2023_08_24.trim/${i}_2P.fastq.gz --genomeDir ../../star-index --outSAMtype BAM SortedByCoordinate \
--outFileNamePrefix ${i} --readFilesCommand zcat; done
...
for i in A4 G3_S9 ; do samtools view -@24 -bq10 ${i}Aligned.sortedByCoord.out.bam -o q10-srt-idx/${i}q10.bam && samtools sort -@24 \
-o q10-srt-idx/${i}q10srt.bam q10-srt-idx/${i}q10.bam && cd q10-srt-idx && samtools index -@24 ${i}q10srt.bam && rm ${i}q10.bam && echo zrobione ${i} \
&& cd .. ; done

# Dla surowych, porównanie wyników multiqc dla surowych osobnych dla dat - wynik b. podobny. W drugim sekw. G3_R1 mniej overrepresented seqs.
pip install --upgrade multiqc

# Z poziomu /media/mj/c8e2ccd2-6313-4092-be34-46144891720f/anal-sekw-ps23
multiqc --interactive 2023_04_20/fastqc/ 2023_07_10/fastqc/ 2023_08_24/fastqc/

# Po trymowaniu, multiqc na wszystkich plikach fastqc (zamiana starego A4 na nowy, dodanie G3_S9 obok starego G3) wyglada OK.
...
multiBamSummary bins \
--bamfiles \
A1q10srt.bam B1q10srt.bam C1q10srt.bam D1q10srt.bam E1q10srt.bam F1q10srt.bam G1q10srt.bam H1q10srt.bam I1q10srt.bam J1q10srt.bam K1q10srt.bam L1q10srt.bam ../../2023_04_20.map/q10-srt-idx/Aq10srt.bam ../../2023_04_20.map/q10-srt-idx/Bq10srt.bam ../../2023_04_20.map/q10-srt-idx/Cq10srt.bam ../../2023_04_20.map/q10-srt-idx/Dq10srt.bam ../../2023_04_20.map/q10-srt-idx/Eq10srt.bam ../../2023_04_20.map/q10-srt-idx/Fq10srt.bam ../../2023_04_20.map/q10-srt-idx/Gq10srt.bam ../../2023_04_20.map/q10-srt-idx/Hq10srt.bam ../../2023_04_20.map/q10-srt-idx/Iq10srt.bam ../../2023_04_20.map/q10-srt-idx/Jq10srt.bam ../../2023_04_20.map/q10-srt-idx/Kq10srt.bam ../../2023_04_20.map/q10-srt-idx/Lq10srt.bam A3q10srt.bam B3q10srt.bam C3q10srt.bam D3q10srt.bam E3q10srt.bam F3q10srt.bam G3q10srt.bam ../../2023_08_24.map/q10-srt-idx/G3_S9q10srt.bam H3q10srt.bam I3q10srt.bam J3q10srt.bam K3q10srt.bam L3q10srt.bam ../../2023_08_24.map/q10-srt-idx/A4q10srt.bam B4q10srt.bam C4q10srt.bam D4q10srt.bam E4q10srt.bam F4q10srt.bam G4q10srt.bam H4q10srt.bam I4q10srt.bam J4q10srt.bam K4q10srt.bam L4q10srt.bam \
--labels \
a5.18d1 a5.02d1 a5.10d1 s0.18d1 s0.02d1 s0.10d1 s8.18d1 s8.02d1 s8.10d1 s3.18d1 s3.02d1 s3.10d1 a5.18d2 a5.02d2 a5.10d2 s0.18d2 s0.02d2 s0.10d2 s8.18d2 s8.02d2 s8.10d2 s3.18d2 s3.02d2 s3.10d2 a5.18d3 a5.02d3 a5.10d3 s0.18d3 s0.02d3 s0.10d3 s8.18d3 s9 s8.02d3 s8.10d3 s3.18d3 s3.02d3 s3.10d3 a5.18d4 a5.02d4 a5.10d4 s0.18d4 s0.02d4 s0.10d4 s8.18d4 s8.02d4 s8.10d4 s3.18d4 s3.02d4 s3.10d4 \
-p 24 -o ../../macierz1powt-liscG3G3_S9.npz
# It run 1h 40 min on 24 cores

plotPCA -in macierz1powt-liscG3G3_S9.npz \
-l \
a5.18d1 a5.02d1 a5.10d1 s0.18d1 s0.02d1 s0.10d1 s8.18d1 s8.02d1 s8.10d1 s3.18d1 s3.02d1 s3.10d1 a5.18d2 a5.02d2 a5.10d2 s0.18d2 s0.02d2 s0.10d2 s8.18d2 s8.02d2 s8.10d2 s3.18d2 s3.02d2 s3.10d2 a5.18d3 a5.02d3 a5.10d3 s0.18d3 s0.02d3 s0.10d3 s8.18d3 s9 s8.02d3 s8.10d3 s3.18d3 s3.02d3 s3.10d3 a5.18d4 a5.02d4 a5.10d4 s0.18d4 s0.02d4 s0.10d4 s8.18d4 s8.02d4 s8.10d4 s3.18d4 s3.02d4 s3.10d4 \
--colors \
'#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#cfd8dc' '#607d8b' '#263238' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#81d4fa' '#03a9f4' '#01579b' '#fff59d' '#fdd835' '#f57f17' '#fff59d' '#fdd835' '#f57f17' '#fff59d' '#ff4dfe' '#fdd835' '#f57f17' '#fff59d' '#fdd835' '#f57f17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' '#ccff90' '#76ff03' '#64dd17' \
--markers \
'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' '*' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' \
--transpose --plotHeight 20 --plotWidth 20 -o pca1p-liscG3G3_S9.svg
...
--markers \
'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' '*' 'o' 'o' 'd' 'd' 'd' 'v' 'v' 'v' 's' 's' 's' 'o' 'o' 'o' 'd' 'd' 'd' \
--transpose --plotHeight 20 --plotWidth 20 --PCs 2 3 -o pca1p23-liscG3G3_S9.svg

plotCorrelation --corData macierz1powt-liscG3G3_S9.npz -c pearson -p heatmap -o liscG3G3_S9.svg
...
# poziom /media/mj/c8e2ccd2-6313-4092-be34-46144891720f/anal-sekw-ps23/2023_07_10.map/q10-srt-idx
multiBamSummary bins \
--bamfiles \
A1q10srt.bam B1q10srt.bam C1q10srt.bam D1q10srt.bam E1q10srt.bam F1q10srt.bam G1q10srt.bam H1q10srt.bam I1q10srt.bam J1q10srt.bam K1q10srt.bam L1q10srt.bam ../../2023_04_20.map/q10-srt-idx/Aq10srt.bam ../../2023_04_20.map/q10-srt-idx/Bq10srt.bam ../../2023_04_20.map/q10-srt-idx/Cq10srt.bam ../../2023_04_20.map/q10-srt-idx/Dq10srt.bam ../../2023_04_20.map/q10-srt-idx/Eq10srt.bam ../../2023_04_20.map/q10-srt-idx/Fq10srt.bam ../../2023_04_20.map/q10-srt-idx/Gq10srt.bam ../../2023_04_20.map/q10-srt-idx/Hq10srt.bam ../../2023_04_20.map/q10-srt-idx/Iq10srt.bam ../../2023_04_20.map/q10-srt-idx/Jq10srt.bam ../../2023_04_20.map/q10-srt-idx/Kq10srt.bam ../../2023_04_20.map/q10-srt-idx/Lq10srt.bam A3q10srt.bam B3q10srt.bam C3q10srt.bam D3q10srt.bam E3q10srt.bam F3q10srt.bam ../../2023_08_24.map/q10-srt-idx/G3_S9q10srt.bam H3q10srt.bam I3q10srt.bam J3q10srt.bam K3q10srt.bam L3q10srt.bam ../../2023_08_24.map/q10-srt-idx/A4q10srt.bam B4q10srt.bam C4q10srt.bam D4q10srt.bam E4q10srt.bam F4q10srt.bam G4q10srt.bam H4q10srt.bam I4q10srt.bam J4q10srt.bam K4q10srt.bam L4q10srt.bam \
--labels \
a5.18d1 a5.02d1 a5.10d1 s0.18d1 s0.02d1 s0.10d1 s8.18d1 s8.02d1 s8.10d1 s3.18d1 s3.02d1 s3.10d1 a5.18d2 a5.02d2 a5.10d2 s0.18d2 s0.02d2 s0.10d2 s8.18d2 s8.02d2 s8.10d2 s3.18d2 s3.02d2 s3.10d2 a5.18d3 a5.02d3 a5.10d3 s0.18d3 s0.02d3 s0.10d3 s8.18d3 s8.02d3 s8.10d3 s3.18d3 s3.02d3 s3.10d3 a5.18d4 a5.02d4 a5.10d4 s0.18d4 s0.02d4 s0.10d4 s8.18d4 s8.02d4 s8.10d4 s3.18d4 s3.02d4 s3.10d4 \
-p 24 -o ../../macierz1powt-lisc-popr.npz

# I don't make plot from it, similar plot has been done previously

~/bin/subread-2.0.6-Linux-x86_64/bin/featureCounts -C -B -Q 10 -F GTF -s 2 -T 24 --ignoreDup -p --countReadPairs -t exon -g gene_id \
-a /media/mj/c8e2ccd2-6313-4092-be34-46144891720f//NAMv5/Zea_mays.Zm-B73-REFERENCE-NAM-5.0.55.chr.gtf -o ../counts1p-popr.txt \
A1q10srt.bam B1q10srt.bam C1q10srt.bam D1q10srt.bam E1q10srt.bam F1q10srt.bam G1q10srt.bam H1q10srt.bam I1q10srt.bam J1q10srt.bam K1q10srt.bam L1q10srt.bam M1q10srt.bam N1q10srt.bam O1q10srt.bam P1q10srt.bam R1q10srt.bam S1q10srt.bam T1q10srt.bam U1q10srt.bam W1q10srt.bam X1q10srt.bam Y1q10srt.bam Z1q10srt.bam ../../2023_04_20.map/q10-srt-idx/Aq10srt.bam ../../2023_04_20.map/q10-srt-idx/Bq10srt.bam ../../2023_04_20.map/q10-srt-idx/Cq10srt.bam ../../2023_04_20.map/q10-srt-idx/Dq10srt.bam ../../2023_04_20.map/q10-srt-idx/Eq10srt.bam ../../2023_04_20.map/q10-srt-idx/Fq10srt.bam ../../2023_04_20.map/q10-srt-idx/Gq10srt.bam ../../2023_04_20.map/q10-srt-idx/Hq10srt.bam ../../2023_04_20.map/q10-srt-idx/Iq10srt.bam ../../2023_04_20.map/q10-srt-idx/Jq10srt.bam ../../2023_04_20.map/q10-srt-idx/Kq10srt.bam ../../2023_04_20.map/q10-srt-idx/Lq10srt.bam ../../2023_04_20.map/q10-srt-idx/Mq10srt.bam ../../2023_04_20.map/q10-srt-idx/Nq10srt.bam ../../2023_04_20.map/q10-srt-idx/Oq10srt.bam ../../2023_04_20.map/q10-srt-idx/Pq10srt.bam ../../2023_04_20.map/q10-srt-idx/Rq10srt.bam ../../2023_04_20.map/q10-srt-idx/Sq10srt.bam ../../2023_04_20.map/q10-srt-idx/Tq10srt.bam ../../2023_04_20.map/q10-srt-idx/Uq10srt.bam ../../2023_04_20.map/q10-srt-idx/Wq10srt.bam ../../2023_04_20.map/q10-srt-idx/Xq10srt.bam ../../2023_04_20.map/q10-srt-idx/Yq10srt.bam ../../2023_04_20.map/q10-srt-idx/Zq10srt.bam A3q10srt.bam B3q10srt.bam C3q10srt.bam D3q10srt.bam E3q10srt.bam F3q10srt.bam ../../2023_08_24.map/q10-srt-idx/G3_S9q10srt.bam H3q10srt.bam I3q10srt.bam J3q10srt.bam K3q10srt.bam L3q10srt.bam M3q10srt.bam N3q10srt.bam O3q10srt.bam P3q10srt.bam R3q10srt.bam S3q10srt.bam T3q10srt.bam U3q10srt.bam W3q10srt.bam X3q10srt.bam Y3q10srt.bam Z3q10srt.bam ../../2023_08_24.map/q10-srt-idx/A4q10srt.bam B4q10srt.bam C4q10srt.bam D4q10srt.bam E4q10srt.bam F4q10srt.bam G4q10srt.bam H4q10srt.bam I4q10srt.bam J4q10srt.bam K4q10srt.bam L4q10srt.bam M4q10srt.bam N4q10srt.bam O4q10srt.bam P4q10srt.bam R4q10srt.bam S4q10srt.bam T4q10srt.bam U4q10srt.bam W4q10srt.bam X4q10srt.bam Y4q10srt.bam Z4q10srt.bam \
--verbose

# New directory for counts
mkdir ../../2023_08_24.counts
cd ..
mv counts ../2023_08_24.counts
# summary
multiqc .
